    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.missions.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('start_at') ? 'is-invalid' : '' }}" type="text" name="start_at" id="start_at" value="{{ old('start_at') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('end_at') ? 'is-invalid' : '' }}" type="text" name="end_at" id="end_at" value="{{ old('end_at') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status">
                    ...
                    @foreach(App\Models\Mission::STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status', 'toComplete') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
